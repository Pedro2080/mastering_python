...
print("Pro" in course)  		 # checking for existance and returns a boolean
print("Swift" not in course)  	 # checking for existance and returns a boolean
...
print(fullName)  # Joao Pedro


# EXAMPLE 2
string = "My first name is {}".format('Joao')
print(string)  # My first name is Joao
